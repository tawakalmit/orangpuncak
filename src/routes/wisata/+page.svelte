...
<Seo
	title={`${data.places.length} Tempat Wisata di Puncak`}
	description={`Daftar ${data.places.length} tempat wisata di kawasan Puncak Bogor & Cianjur: wisata alam, keluarga, dan rekreasi.`}
	path="/wisata"
/>

<div class="mx-auto max-w-content px-4 py-8 2xl:px-0 lg:w-11/12">
	<h1 class="section-title">Tempat Wisata di Puncak</h1>
	<p class="mt-2 text-ink/70">Jelajahi {data.places.length} destinasi wisata pilihan.</p>
