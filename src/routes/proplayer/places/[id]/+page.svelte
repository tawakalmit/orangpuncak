...
<PlaceForm place={data.place} allPlaces={data.allPlaces} allCategories={data.allCategories} allVillaComplexes={data.allVillaComplexes} error={form?.error} submitLabel="Perbarui" formAction="?/update" />
